...
MenuBar()
MenuItem(#addDirectory,"Add Directory...")
MenuItem(#addFile,"Add File(s)...")

MenuTitle("Playlist")
MenuItem(#playlistFind,"Find..." + Chr(9) + "+CMD+F")
MenuItem(#playlistDontGroupByAlbums,"Don't group by albums")
MenuBar()
MenuItem(#playlistShiftUp,"Move item up" + Chr(9) + "+SHIFT+↑")
MenuItem(#playlistShiftDown,"Move item down" + Chr(9) + "+SHIFT+↓")
MenuBar()
MenuItem(#playlistQueue,"Queue" + Chr(9) + "+␣")
MenuItem(#playlistPlay,"Play" + Chr(9) + "+⏎")
MenuItem(#playlistFinder,"Reveal in Finder")
...
SetListIconColumnHeaderJustification(#playlist,#status,#justifyCenter)
SetListIconColumnHeaderJustification(#playlist,#track,#justifyRight)
SetListIconColumnHeaderJustification(#playlist,#duration,#justifyCenter)
SetListIconColumnHeaderJustification(#playlist,#details,#justifyRight)
...
;CocoaMessage(0,GadgetID(#playlist),"setFloatsGroupRows:",#YES)
...
Macro prefs()
  ...
  AddGadgetItem(#prefsPanel,-1,"Shortcuts")
  ButtonGadget(#prefsShortcutEdit,5,10,100,25,"Edit")
  TextGadget(#prefsShortcutToggleLabel,10,45,250,20,"Play/Pause:")
  ShortcutGadget(#prefsShortcutToggle,10,65,100,20,0)
  CocoaMessage(0,GadgetID(#prefsShortcutToggle),"setFocusRingType:",1)
  TextGadget(#prefsShortcutNextLabel,10,95,250,20,"Next track:")
  ShortcutGadget(#prefsShortcutNext,10,115,100,20,0)
  CocoaMessage(0,GadgetID(#prefsShortcutNext),"setFocusRingType:",1)
  TextGadget(#prefsShortcutPreviousLabel,10,145,250,20,"Previous track:")
  ShortcutGadget(#prefsShortcutPrevious,10,165,100,20,0)
  CocoaMessage(0,GadgetID(#prefsShortcutPrevious),"setFocusRingType:",1)
  TextGadget(#prefsShortcutFindLabel,10,195,250,20,"Find:")
  ShortcutGadget(#prefsShortcutFind,10,215,100,20,0)
  CocoaMessage(0,GadgetID(#prefsShortcutFind),"setFocusRingType:",1)
  SetGadgetText(#prefsShortcutToggle,settings\shortcuts\toggle_shortcut)
  SetGadgetText(#prefsShortcutNext,settings\shortcuts\next_shortcut)
  SetGadgetText(#prefsShortcutPrevious,settings\shortcuts\previous_shortcut)
  SetGadgetText(#prefsShortcutFind,settings\shortcuts\find_shortcut)
...
Macro action()
  OpenWindow(#wndFind,0,0,400,300,"Find",#PB_Window_WindowCentered|#PB_Window_SystemMenu|#PB_Window_Tool|#PB_Window_Invisible,WindowID(#wnd))
  ...
  AddKeyboardShortcut(#wndFind,#PB_Shortcut_Up,#actionUp)
  AddKeyboardShortcut(#wndFind,#PB_Shortcut_Down,#actionDown)
  AddKeyboardShortcut(#wndFind,#PB_Shortcut_Escape,#actionCancel)
  AddKeyboardShortcut(#wndFind,#PB_Shortcut_Return,#actionConfirm)
  HideWindow(#wndFind,#False)
